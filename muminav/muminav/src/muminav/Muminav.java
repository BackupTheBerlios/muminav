...
/**
 *  This is the main class of the applet which controls the
 *  other parts.
 *
 *@author     glaessel
...
public class Muminav extends Applet {
    ...
    /**
     *  Called if the applet is started or the applet
     *  container is reiconized or if it gets the focus.
     */
    public void start() {
        /*
    ...
    /**
     *  Called if the applet container is iconized or if it
     *  losts the focus.
     */
    public void stop() {
        /*
    ...
    public void init() {
        ...
        try {
            // load the xml file
            URL url = new URL( super.getParameter( "XMLFile" ) );
    ...
    /**
     *  Gets the parameterInfo attribute of the Muminav
     *  object
     *
...
/*
 *  $Id: Muminav.java,v 1.7 2002/09/17 02:11:28 ercmat Exp $
 */
