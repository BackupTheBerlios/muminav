...
public class Connector extends Part {
	...
	public void drawBresenham(Graphics g, int x0, int y0, int x1, int y1, int thickness) {
		...
		// we work with fillRect at thickness 2 instead of fillOval, because java isn't able
		// to draw circles with 2 pixels diameter

		// note: the main part from this method was token from a friend
		// he uses german names and german comments
